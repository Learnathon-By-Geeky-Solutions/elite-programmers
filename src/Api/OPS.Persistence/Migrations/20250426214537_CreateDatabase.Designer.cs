...
namespace OPS.Persistence.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the entity model for the application's database schema, defining tables, properties, relationships, indexes, and seed data using the Entity Framework Core ModelBuilder API.
        /// </summary>
